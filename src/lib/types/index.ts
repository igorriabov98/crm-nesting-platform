...
export type ProductionMachineItemFact = Database['public']['Tables']['production_machine_item_facts']['Row']
export type ProductionTonnageFact = Database['public']['Tables']['production_tonnage_facts']['Row']
export type FactoryWorkCalendarException = Database['public']['Tables']['factory_work_calendar_exceptions']['Row']
export type ProductionSectionCapacityPeriod = Database['public']['Tables']['production_section_capacity_periods']['Row']
...
export type TechnologistRequestApprovalVersion = Database['public']['Tables']['technologist_request_approval_versions']['Row']
export type TechnologistRequestApprovalArchive = Database['public']['Tables']['technologist_request_approval_archives']['Row']
export type InventoryTransfer = Database['public']['Tables']['inventory_transfers']['Row']
export type InventoryTransferItem = Database['public']['Tables']['inventory_transfer_items']['Row']
...
export type MachineCuttingArchive = Database['public']['Tables']['machine_cutting_archives']['Row']
