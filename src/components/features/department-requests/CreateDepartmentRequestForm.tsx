...
export function CreateDepartmentRequestForm({
  ...
  const [target, setTarget] = useState<Exclude<DepartmentRequestTarget, 'planning' | 'finance'>>('supply')
            ...
            <div className="space-y-5 px-5 py-5 sm:px-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={target}
                  onChange={(event) => setTarget(event.target.value as Exclude<DepartmentRequestTarget, 'planning' | 'finance'>)}
                ...
                >
                  {(Object.entries(DEPARTMENT_REQUEST_TARGETS) as Array<[DepartmentRequestTarget, typeof DEPARTMENT_REQUEST_TARGETS[DepartmentRequestTarget]]>)
                    .filter(([value]) => value !== 'planning' && value !== 'finance')
                    .map(([value, config]) => (
