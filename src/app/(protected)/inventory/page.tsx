...
import { canManageInventory, getInventory, getInventoryFactories, getSheetImportFactoryIds } from '@/lib/actions/inventory'
...
async function InventoryRoute({
  ...
  const [{ data, error }, suppliersResult, steelTypes, canManage, sheetImportFactoryIds] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      {pageError ? (
        ...
        <InventoryPage
          ...
          sheetImportFactoryIds={sheetImportFactoryIds}
