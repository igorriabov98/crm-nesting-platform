...
assert.match(supplyRequests, /Согласование аутсорсинга/)
...
assert.match(outsourcingTab, /data\.items\.filter\(\(item\) => isZincCoating\(item\.coating\)\)/)
assert.match(outsourcingTab, /COATINGS\[item\.coating\]\.label/)
