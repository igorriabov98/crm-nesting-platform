...
for(const suite of ['organization_access_test.sql','organization_rls_test.sql','organization_member_management_test.sql','task_notifications_material_type_test.sql']){
