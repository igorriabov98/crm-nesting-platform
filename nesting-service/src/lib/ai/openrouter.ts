...
- Если на чертеже есть несколько видов детали, unfolding_width/unfolding_height бери ТОЛЬКО с плоского вида развёртки, а не с согнутого, сборочного или рабочего вида.
- Признаки плоской развёртки: линии сгиба (штрихпунктир), отсутствие толщины/сечения, размеры больше проекции согнутой детали, подписи "Развертка", "Развёртка", "Zuschnitt", "Flat pattern".
- Если распознаны размеры и согнутого вида, и развёртки, выбирай размеры развёртки; при прочих равных предпочитай больший плоский габарит, потому что развёртка не может быть меньше согнутой проекции по соответствующему направлению.
- Анти-пример: ЛЕДА.228.02.001 — 707.6x1210 относится к согнутому виду, 1210x771.1 относится к развёртке; вернуть unfolding_width=1210, unfolding_height=771.1.
